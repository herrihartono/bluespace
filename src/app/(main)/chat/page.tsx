          ...
          {chats.map((chat) => {
            ...
            return (
              <Link
                key={chat.id}
                href={`/chat/${chat.id}`}
                className="flex items-center gap-3 bg-white rounded-2xl border border-blue-50 p-4 hover:shadow-md transition-shadow"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {chat.lastMessage && (
                    <p className="text-gray-500 text-sm truncate mt-0.5">{chat.lastMessage}</p>
                  )}
                  {display.isGroup && (
